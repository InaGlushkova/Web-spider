import scrapy
from Example.items11 import FundrazrItem
...
class Fundrazr(scrapy.Spider):
	...
	def parse_dir_contents(self, response):
		...
		item['endDate'] = "".join(response.xpath("//div[contains(@id, 'campaign-stats')]//span[contains(@class,'stats-label hidden-phonce')]/span[@class='nowrap']/text()").extract()).strip()
